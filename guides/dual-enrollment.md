...
**Dual enrollment** means taking community college courses while still in high school (or while finishing high school requirements). Done well, it is one of the highest-leverage tools for Bay Area students aiming at UC.
...
| | Dual enrollment (CCC) | AP |
|--|------------------------|-----|
| Credit | College units on a CCC transcript | Depends on AP score + campus policy |
| Grade | Letter grade enters college GPA | AP score separate; HS grade is HS |
| Schedule | Often evening/online/summer; flexible | Usually during school day |
| Articulation | Map via assist.org / A-G lists | Score charts for credit/placement |
| Risk | College W/D/F stays on college record | Lower score mainly loses credit |

**Best practice:** Use both when useful. AP for subjects your school teaches excellently; dual enrollment for bottlenecks, summer acceleration, or courses your HS can’t fit.

---

## Bay Area logistics (what actually blocks students)
...
| Risk | Mitigation |
|------|------------|
| Overload → low grades | Cap units; protect sleep and HS core |
| Non-transferable course | Check assist.org + UC transferable list before enrolling |
| District won’t accept for HS credit | Get written approval first; separate HS graduation plan from UC plan |
| Messy transcript (W’s) | Drop by deadline; don’t ghost the class |
| Prerequisite surprises | Read catalog + talk to CCC counselor early |

---

## Pairing dual enrollment with AP (doable competitiveness)
