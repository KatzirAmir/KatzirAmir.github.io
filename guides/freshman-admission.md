...
## 1. A-G is the floor, not the strategy

[A-G](https://admission.universityofcalifornia.edu/admission-requirements/first-year-requirements/subject-requirement-a-g.html) is the minimum pattern to be eligible. Competitive campuses effectively require **more years of A-G** and **harder courses** than the minimum.

| Area | Subject | Minimum (typical) | What competitive students usually do |
|------|---------|-------------------|--------------------------------------|
| A | History / social science | 2 years | Stay in rigorous sequence |
| B | English | 4 years | Never drop English; dual enroll only if HS credit is safe |
| C | Math | 3 years (4 recommended) | Through precalc / calc if you can do it cleanly |
| D | Lab science | 2 years (3 recommended) | Bio + chem + physics (or solid third) for STEM |
| E | Language other than English | 2 years (3 recommended) | Through level 3+ when possible |
| F | Visual & performing arts | 1 year | One full year (or two semesters) in **one** discipline |
| G | College-prep elective | 1 year | Often filled automatically if you’re loaded |

### How to check your school

1. Open the [UC A-G Course List](https://hs-articulation.ucop.edu/agcourselist)
2. Search your high school
3. Only courses on **that** list count as A-G for your school
4. Honors only get UC weight if they show UC-approved honors type (“H”)

If you’re out-of-state/international, map against the UC subject requirement page and use AP/IB/college courses as UC describes.
...
## 2. Course validation (math & language)
...
## 3. Rigor: honors, AP, IB, community college

UCs care that you took the hard path **available to you**.

### Weighting reality check

UC-approved honors, AP, IB, and eligible community college coursework are treated as advanced. There is no secret hierarchy like “AP always beats honors” when both are UC-approved. What matters: **did you challenge yourself relative to your school, and did you perform?**

### Community college while in high school (high leverage)
...
A=4, B=3, C=2, D=1, F=0. Sum points, divide by semesters counted. Simple.

### Weighted / fully weighted GPA

Extra grade point for UC-approved honors / AP / IB / eligible CC courses in the UC GPA window. Competitive campuses (think Berkeley/UCLA-level) look at **unweighted and fully weighted**, not just the eligibility “capped” number.

**Capped GPA (often “8 semester honors points”)** is mainly for **UC eligibility minimums** (e.g. resident vs nonresident floors). It is **not** a reason to stop taking advanced courses after four honors classes. Evaluation looks beyond the eligibility cap.
...
## 5. Extracurriculars that actually read
...
UC has been **test-free** for SAT/ACT in recent cycles; always re-check. Don’t build a multi-year plan that only works if the SAT returns. AP/IB remain useful for credit and signal.

---

## 7. Campus + major strategy

You apply to **campuses**, and many admit **by major** or college with very different odds.
...
## 8. Application timeline (working version)

| When | Job |
|------|-----|
| 9th–10th | Lock A-G foundation; start 1–2 deep activities; learn dual enrollment rules |
| Summer before 11th | Optional CCC / rigor boost if needed |
| 11th | Peak academics; draft activities list; shortlist campuses |
| Summer before 12th | PIQ brainstorm; finalize list; last dual enrollment if useful |
| Oct 1 – Dec 1 | UC app window (confirm dates each year) |
| Winter–spring | Decisions, waitlists, SIR, housing |
