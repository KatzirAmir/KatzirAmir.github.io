...
It’s a general-education checklist so California community college students can finish lower-division GE in a package UCs and CSUs generally accept. It is **not** a degree and it does **not** replace major preparation.

---

## Why it exists

Without a shared GE pattern, each destination campus can demand different breadth courses. IGETC reduces wasted units when you apply to multiple campuses.

What it does **not** do: make you competitive for a selective major if your major prep and GPA are weak.

---

## Conceptual area map

Exact course lists are **college-specific**. Conceptually:

| Area | Theme |
|------|--------|
| 1 | English composition / critical thinking (and oral communication nuances for CSU) |
